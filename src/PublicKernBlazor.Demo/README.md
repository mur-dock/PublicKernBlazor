...
Interaktive Showcase-App für die **PublicKernBlazor.Components**-Komponentenbibliothek.  
...
```powershell
# Im Verzeichnis PublicKernBlazor.Demo
dotnet run
```
...
└── wwwroot/
    └── app.css                     # Leer – alle Styles kommen aus PublicKernBlazor.Components
```
...
Die Demo zeigt, wie `PublicKernBlazor.Components` in einer Blazor-Anwendung verwendet wird.
